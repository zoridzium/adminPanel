...
// Initialize jQuery utilities datepicker translations while using some of the translations
...
fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
	...
	// is jQuery utilities Datepicker is on the page?
	if ($.datepicker) {
...
Grid.mixin({
	...
	// Called when a jQuery utilities drag is initiated anywhere in the DOM
	...
	// Called when a jQuery utilities drag starts and it needs to be monitored for cell dropping
...
var View = fc.View = Class.extend({
	...
	// Must be called when an external element, via jQuery utilities, has been dropped onto the calendar.
