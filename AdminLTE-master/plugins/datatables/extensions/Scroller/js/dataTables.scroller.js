...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	_domain: function ( dir, val )
	{
		...
		// can stutter badly - on large else 30px (for example) scroll might
			 ...
			 typeof this.s.dt.oLoadedState.iScroller != 'undefined' )
		{
			     ...
			     (!ajaxSourced && this.s.dt.iDraw == 1) )
			{
				setTimeout( function () {
					...
					// In order to prevent scriptSettings thrashing we need another
					// small delay
					setTimeout( function () {
	 ...
	 * be used to allow Scroller to display else of any number of records.
	 *  @returns {void}
	 *  @private
	 */
